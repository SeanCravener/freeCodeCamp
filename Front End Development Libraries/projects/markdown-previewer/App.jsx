            ...
            <div className='row text-center'>
                <div className='col-sm-12 text-center p-5'>
                    ...
                    <div className='col-md-6 p-3 d-flex'>
                        <textarea className='container-fluid' id='editor' type='text' value={editorText} onChange={onChange}></textarea>
                    </div>
                    <div className='col-md-6 p-3 d-flex'>
                        <div className='container-fluid' id='preview' dangerouslySetInnerHTML={createMarkup()}></div>
                    </div>
                </div>
            </div>
    );
